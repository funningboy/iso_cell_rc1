...
public :
      void         dump_Context(){
                   ...
                   std::cout << "@" << this << endl;
                   std::cout << "  @NOR->Src1   " << this->get_Src1() << endl;
                   std::cout << "  @NOR->Src2   " << this->get_Src2() << endl;
                   std::cout << "  @NOR->Dst    " << this->get_Dst()  << endl;

                   }

public :
      void         run_SC_NOR_Time(){
                   ...
                   assert( src1_p !=NULL &&
                           src2_p !=NULL &&
                           dst_p  !=NULL && "<Err> SC_OR::run_SC_NOR");
      ...
      void         run_SC_NOR_Logic(){
          ...
          */
           ...
           if( first == SC_Logic::SC_LOGIC_0 && second == SC_Logic::SC_LOGIC_0 ||
               first == SC_Logic::SC_LOGIC_f && second == SC_Logic::SC_LOGIC_0 ){ dst_p_l->set_CurLogic(SC_Logic::SC_LOGIC_1); return; }
           ...
           if( first == SC_Logic::SC_LOGIC_0 && second == SC_Logic::SC_LOGIC_r ){ dst_p_l->set_CurLogic(SC_Logic::SC_LOGIC_f); return; }
          ...
          */
           ...
           if( first == SC_Logic::SC_LOGIC_0 && second == SC_Logic::SC_LOGIC_0 ){ dst_p_l->set_CurLogic(SC_Logic::SC_LOGIC_1); return; }
