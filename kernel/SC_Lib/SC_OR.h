...
public :
      void         dump_Context(){
                   ...
                   std::cout << "@" << this << endl;
                   std::cout << "  @OR->Src1   " << this->get_Src1() << endl;
                   std::cout << "  @OR->Src2   " << this->get_Src2() << endl;
                   std::cout << "  @OR->Dst    " << this->get_Dst()  << endl;
      ...
      void         run_SC_OR_Logic(){
          ...
          */
           ...
           if( first == SC_Logic::SC_LOGIC_0 && second == SC_Logic::SC_LOGIC_0 ||
               first == SC_Logic::SC_LOGIC_f && second == SC_Logic::SC_LOGIC_0 ){ dst_p_l->set_CurLogic(SC_Logic::SC_LOGIC_0); return; }
           ...
           if( first == SC_Logic::SC_LOGIC_0 && second == SC_Logic::SC_LOGIC_1 || 
               ...
               first == SC_Logic::SC_LOGIC_r && second == SC_Logic::SC_LOGIC_f ||
               first == SC_Logic::SC_LOGIC_r && second == SC_Logic::SC_LOGIC_r ){ dst_p_l->set_CurLogic(SC_Logic::SC_LOGIC_1); return; }
          
           if( first == SC_Logic::SC_LOGIC_0 && second == SC_Logic::SC_LOGIC_r ){ dst_p_l->set_CurLogic(SC_Logic::SC_LOGIC_r); return; }
           
           if( first == SC_Logic::SC_LOGIC_0 && second == SC_Logic::SC_LOGIC_f || 
               first == SC_Logic::SC_LOGIC_f && second == SC_Logic::SC_LOGIC_f ){ dst_p_l->set_CurLogic(SC_Logic::SC_LOGIC_f); return; }
          ...
          */
           ...
           if( first == SC_Logic::SC_LOGIC_0 && second == SC_Logic::SC_LOGIC_0 ){ dst_p_l->set_CurLogic(SC_Logic::SC_LOGIC_0); return; }
