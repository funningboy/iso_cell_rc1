...
public :
      void         dump_Context(){
                   ...
                   std::cout << "  @AND->Src1   " << this->get_Src1() << std::endl;
                   std::cout << "  @AND->Src2   " << this->get_Src2() << std::endl;
                   std::cout << "  @AND->Dst    " << this->get_Dst()  << std::endl;

                  }

public :
      void         run_SC_AND_Time(){
                   ...
                   assert( src1_p !=NULL &&
                           src2_p !=NULL &&
                           dst_p  !=NULL && "<Err> SC_OR::run_SC_AND");
...
public :
      void         run_SC_AND_Logic(){
                   ...
                   assert( src1_p !=NULL &&
                           src2_p !=NULL &&
                           dst_p  !=NULL && "<Err> SC_AND::run_SC_AND");
          ...
          //
           ...
           if( first == SC_Logic::SC_LOGIC_1 && second == SC_Logic::SC_LOGIC_1 ){ dst_p_l->set_CurLogic(SC_Logic::SC_LOGIC_1); return; }
